...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'abfdd73aac54eb2585be58e5877587cd27f6a10de17c6feb71c8af7569381361_1' => 'getAbfdd73aac54eb2585be58e5877587cd27f6a10de17c6feb71c8af75693813611Service',
            ...
            'c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_1' => 'getC2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b1Service',
            'c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_2' => 'getC2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b2Service',
            'c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_3' => 'getC2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b3Service',
    ...
    /**
     * Gets the 'abfdd73aac54eb2585be58e5877587cd27f6a10de17c6feb71c8af7569381361_1' service.
     *
     ...
     */
    protected function getAbfdd73aac54eb2585be58e5877587cd27f6a10de17c6feb71c8af75693813611Service()
    {
        return $this->services['abfdd73aac54eb2585be58e5877587cd27f6a10de17c6feb71c8af7569381361_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/leadsfactory/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/leadsfactory/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/var/www/leadsfactory/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    /**
     * Gets the 'c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getC2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b1Service()
    {
        return $this->services['c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the 'c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getC2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b2Service()
    {
        return $this->services['c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the 'c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getC2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b3Service()
    {
        return $this->services['c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/leadsfactory/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'leadsfactory', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager53f46eef65d65_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager53f46eef65d65_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/leadsfactory/app/cache/dev/jms_diextra/doctrine/EntityManager_53f46eef65d65.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_bfb71d9d3123bbe10c221f4ce02e17bce083b5944b2b61fb67eb2413900ecede');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_bfb71d9d3123bbe10c221f4ce02e17bce083b5944b2b61fb67eb2413900ecede');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_bfb71d9d3123bbe10c221f4ce02e17bce083b5944b2b61fb67eb2413900ecede');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/leadsfactory/src/Tellaw/LeadsFactoryBundle/Entity')), 'Tellaw\\LeadsFactoryBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('TellawLeadsFactoryBundle' => 'Tellaw\\LeadsFactoryBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/var/www/leadsfactory/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager53f46eef65d65_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Tellaw\LeadsFactoryBundle\Utils\Fields\EmailFieldType A Tellaw\LeadsFactoryBundle\Utils\Fields\EmailFieldType instance.
     */
    protected function getEmailfieldtypeService()
    {
        return $this->services['emailfieldtype'] = new \Tellaw\LeadsFactoryBundle\Utils\Fields\EmailFieldType();
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/leadsfactory/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('abfdd73aac54eb2585be58e5877587cd27f6a10de17c6feb71c8af7569381361_1'), $this->get('data_collector.form'));
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/leadsfactory/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/leadsfactory/app/logs/dev.log', 200, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/leadsfactory/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/leadsfactory/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/var/www/leadsfactory/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Tellaw\\LeadsFactoryBundle\\Entity\\Users' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/leadsfactory/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/leadsfactory/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/leadsfactory/app/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/leadsfactory/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_1'), 1 => $this->get('c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_2'), 2 => $this->get('c2d449c7562230040937a828467826a04a18dda8f31fc01f0ed3e4acee8c0a8b_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/leadsfactory/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/leadsfactory/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/leadsfactory/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/leadsfactory/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/leadsfactory/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/var/www/leadsfactory/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/leadsfactory/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/leadsfactory/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/leadsfactory/src/Tellaw/LeadsFactoryBundle/Resources/views', 'TellawLeadsFactory');
        $instance->addPath('/var/www/leadsfactory/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/var/www/leadsfactory/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/var/www/leadsfactory/app/Resources/views');
        $instance->addPath('/var/www/leadsfactory/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/var/www/leadsfactory/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/leadsfactory/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/leadsfactory/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Extra_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/leadsfactory/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Tellaw\\LeadsFactoryBundle\\Entity\\Users', 'login', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/leadsfactory/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/leadsfactory/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/leadsfactory/app/cache/dev',
            'kernel.logs_dir' => '/var/www/leadsfactory/app/logs',
            'kernel.bundles' => array(
                ...
                'TellawLeadsFactoryBundle' => 'Tellaw\\LeadsFactoryBundle\\TellawLeadsFactoryBundle',
            ...
            'debug.container.dump' => '/var/www/leadsfactory/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/var/www/leadsfactory/app/sessions',
            ...
            'profiler.storage.dsn' => 'file:/var/www/leadsfactory/app/cache/dev/profiler',
            ...
            'router.resource' => '/var/www/leadsfactory/app/cache/dev/assetic/routing.yml',
            ...
            'swiftmailer.spool.default.memory.path' => '/var/www/leadsfactory/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/var/www/leadsfactory/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/leadsfactory/app/../web',
            'assetic.write_to' => '/var/www/leadsfactory/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/leadsfactory/app/cache/dev/doctrine/orm/Proxies',
            'doctrine.orm.proxy_namespace' => 'Proxies',
            'jms_aop.cache_dir' => '/var/www/leadsfactory/app/cache/dev/jms_aop',
            ...
            'security.extra.cache_dir' => '/var/www/leadsfactory/app/cache/dev/jms_security',
            ...
            'jms_di_extra.cache_dir' => '/var/www/leadsfactory/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/leadsfactory/app/cache/dev/jms_diextra/doctrine/EntityManager_53f46eef65d65.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager53f46eef65d65_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
