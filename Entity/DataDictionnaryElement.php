...
class DataDictionnaryElement {
    ...
    /**
     * @var string $children
     * @ORM\OneToMany(targetEntity="Tellaw\LeadsFactoryBundle\Entity\DataDictionnaryElement", mappedBy="parent")
     */
    protected $children;

    /**
     * @var string $parent
     * @ORM\ManyToOne(targetEntity="Tellaw\LeadsFactoryBundle\Entity\DataDictionnaryElement", inversedBy="children")
     * @ORM\JoinColumn(name="parent_id", referencedColumnName="id")
     */
    protected $parent;

    /**
     * @ORM\ManyToOne(targetEntity="Tellaw\LeadsFactoryBundle\Entity\DataDictionnary", inversedBy="elements")
     ...
     * @return ReferenceListElement
     */
    public function addChild(\Tellaw\LeadsFactoryBundle\Entity\DataDictionnaryElement $children)
    {
     ...
     * @param \Tellaw\LeadsFactoryBundle\Entity\ReferenceListElement $children
     */
    public function removeChild(\Tellaw\LeadsFactoryBundle\Entity\DataDictionnaryElement $children)
    {
