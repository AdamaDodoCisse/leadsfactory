...
use LeadsFactoryBundle\Entity\Bookmark;
use LeadsFactoryBundle\Shared\CoreController;
use LeadsFactoryBundle\Utils\AlertUtils;
use LeadsFactoryBundle\Utils\Chart;
...
class MonitoringController extends CoreController
{
    ...
    public function getUtmLinkedToFormAction($form_id)
    {
        ...
        /** @var LeadsFactoryBundle\Utils\LFUtils $utils */
        $utils = $this->container->get('lf.utils');
    ...
    public function chartDashboardAction($period = Chart::PERIOD_YEAR, $mode = 'FormType', $objects = null)
    {
        ...
        /** @var $chart \LeadsFactoryBundle\Utils\Chart */
