...
use LeadsFactoryBundle\Entity\Leads;
use LeadsFactoryBundle\Entity\Tracking;
use LeadsFactoryBundle\Response\TransparentPixelResponse;
...
class FrontController extends CoreController
{
    ...
    public function trackingAction(Form $form, $utm_campaign = '')
    {
        ...
        // Track call request
        /** @var \LeadsFactoryBundle\Entity\Tracking $tracking */
    ...
    {
        /** @var \LeadsFactoryBundle\Utils\JsUtils $formUtils */
