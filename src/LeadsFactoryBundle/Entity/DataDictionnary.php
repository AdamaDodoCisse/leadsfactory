 ...
 *
 *
 * @ORM\Entity(repositoryClass="LeadsFactoryBundle\Entity\DataDictionnaryRepository")
 */
class DataDictionnary
{

    /**
     * @ORM\OneToMany(targetEntity="LeadsFactoryBundle\Entity\DataDictionnaryElement", mappedBy="dataDictionnary", cascade={"persist"})
     ...
     * Add elements
     *
     * @param \LeadsFactoryBundle\Entity\DataDictionnaryElement $elements
