...
/**
 * @ORM\Entity(repositoryClass="LeadsFactoryBundle\Entity\ExportRepository")
 */
class Export
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="LeadsFactoryBundle\Entity\Leads")
     ...
     * Set lead
     *
     * @param \LeadsFactoryBundle\Entity\Leads $lead
     * @return Export
     */
    public function setLead(\LeadsFactoryBundle\Entity\Leads $lead = null)
    {
        $this->lead = $lead;
     ...
     * Get lead
     *
     * @return \LeadsFactoryBundle\Entity\Leads
     */
