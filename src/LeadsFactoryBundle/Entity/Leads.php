 ...
 *
 * @ORM\Entity(repositoryClass="LeadsFactoryBundle\Entity\LeadsRepository")
 */
class Leads
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="LeadsFactoryBundle\Entity\FormType", inversedBy="leads")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="LeadsFactoryBundle\Entity\Person", inversedBy="leads")
     * @ORM\JoinColumn(name="client_id", referencedColumnName="id")
     */
    private $client;

    /**
     * @ORM\ManyToOne(targetEntity="LeadsFactoryBundle\Entity\Entreprise", inversedBy="leads")
     ...
     * @deprecated
     * @see setData
     * @param \LeadsFactoryBundle\Entity\longtext $content
     */
    ...
    /**
     * @param \LeadsFactoryBundle\Entity\datetime $exportdate
     */
    ...
    /**
     * @return \LeadsFactoryBundle\Entity\datetime
     */
     ...
     * Set formId
     *
     * @param \LeadsFactoryBundle\Entity\Form $formId
     * @return Leads
     */
    public function setFormId(\LeadsFactoryBundle\Entity\Form $formId = null)
    {
        $this->formId = $formId;
